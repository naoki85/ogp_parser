...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'OGP Parser is a Gem which analyzes the OGP of the target URL.'
  spec.description   = 'OGP Parser is a Gem which analyzes the OGP of the target URL. After install this Gem, you can easily get ogp property in the target website.'
